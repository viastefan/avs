export const site = {
  ...
  description:
    "Airport-Verpackungs-Service GmbH am Flughafen München — Export-, Gefahrgut- und Schwergutverpackung, Containerstauung und Gefahrgutschulung. Standort: Südallee, Frachtzentrum Modul H.",
